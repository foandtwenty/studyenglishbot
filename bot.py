...
HELP_TEXT = (
    ...
    "*Как работает:*\n"
    "Сначала вспоминаешь сам, потом смотришь ответ и честно оцениваешь: знал "
    "или нет. Ошибочные карточки возвращаются через 2–3 хода и ещё раз в конце.\n\n"
    "*Как начать тренировку:*\n"
    "🎯 Тренировка дня — бот сам собирает: сложное первым, плюс немного новых слов\n"
    "🎲 Всё вперемешку — случайная подборка любого размера, без расписания\n"
    "📚 Своя тема — выбираешь тему и уровень сам\n\n"
    "*Перед стартом темы:*\n"
    "Уровень — 🟢 Базовый (частые), 🟡 Средний, 🔴 Продвинутый или «Все»\n"
    "❗ Только ошибки — тренировать свои сложные карточки\n"
    "✏️ Ввод ответа — печатать формы вместо кнопок\n"
    "🔄 Направление RU→EN — видишь перевод, вспоминаешь глагол и формы\n\n"
    "*На карточке глагола:*\n"
    "💡 Подсказка — первая буква и длина формы (карточка вернётся на повтор)\n"
    "✏️ В режиме ввода: пишешь формы сообщением, «❓ Не помню» покажет ответ\n"
    "✅ Опечатка в длинном слове не помешает — засчитается как верно\n"
    "➡️ Любой текст на экране результата работает как «Дальше»\n"
    "↩️ «Отмена» — если ошибся с ответом, можно попробовать снова\n\n"
    "*⚙️ Профиль:*\n"
    "📊 Прогресс — статистика и последние тренировки\n"
    "📋 Сложные карточки — тренировка своих ошибок\n"
